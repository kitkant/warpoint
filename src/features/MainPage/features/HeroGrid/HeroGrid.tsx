				...
				<div className={styles.gridContainer}>
					...
					<div className={styles.cardContainer}>
						<Card
							...
							text={
								<>
									Участники погрузятся{mobile480 ? <br /> : <></>} в
									захватывающий
									{mobile480 ? <></> : laptop640 ? <br /> : <></>}
									...
									где буквально окажутся
									{mobile480 ? <></> : laptop640 ? <br /> : <></>}
									{laptop960 ? <></> : <br />} в центре
									{mobile480 ? <br /> : <></>} событий! Ничто не помешает{' '}
									{laptop640 ? <br /> : <></>}
									{laptop960 ? <> </> : <br />}
									погружению в игру -{mobile480 ? <br /> : <></>} из
									оборудования только
									{mobile480 ? <></> : laptop640 ? <br /> : <></>}
									{laptop960 ? <></> : <br />} новейшие
									{mobile480 ? <br /> : <></>} беспроводные VR-очки Oculus
									{mobile480 ? <br /> : <></>} Quest
								</>
							}
							index={2}
				...
				<div className={styles.gridContainer}>
					<div className={styles.cardContainer}>
						<Card
							...
							text={
								<>
									Современная альтернатива{mobile480 ? <br /> : <></>} скучным
									{mobile480 ? <></> : laptop640 ? <br /> : <></>} посиделкам в
									кафе. Пока{mobile480 ? <br /> : <></>} часть гостей
									{mobile480 ? <></> : laptop640 ? <br /> : <></>} развлекается
									на VR-{mobile480 ? <br /> : <></>}арене, остальные могут
									{mobile480 ? <></> : laptop640 ? <br /> : <></>} кушать,
									{mobile480 ? <br /> : <></>} играть в настолки или приставку
									{laptop640 ? <br /> : <></>} в просторной лаунж-зоне
								</>
							}
							index={3}
							cover={mobile480 ? true : false}
